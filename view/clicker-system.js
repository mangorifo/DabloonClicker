  ...
  function update_workers() {
      ...
      e2.innerHTML = parseFloat(click_rate / 1000.0).toFixed(3);
  ...
  document.getElementById("upgrade_speed").onclick = function() {
      ...
      e2.innerHTML = 'Buy for ' + ((Math.pow(3, upgrade_speed)) * 100) + ' dabloons';
  ...
  document.getElementById("increase_clicks").onclick = function() {
      ...
      e2.innerHTML = 'Buy for ' + ((Math.pow(3, click_increment)) * 100) + ' dabloons';
  };
